import { AcceptAnAgreementUsecase } from './accept-an-agreement-usecase';
...
describe('AcceptAnAgreementUsecase', () => {
  ...
  it('should accept an agreement and notify the parties', async () => {
