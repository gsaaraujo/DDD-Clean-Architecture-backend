...
describe('accept-an-agreement-usecase', () => {
  ...
  it('should accept an agreement as creditor and notify the debtor', async () => {
    ...
    expect(mockNotifyPartiesUsecase.execute).toHaveBeenCalledWith({
      title: any(),
      content:
        'The creditor 0e9f8d3b-4c66-49b0-b739-d443b15e1f4e has accepted his part of the agreement.',
  ...
  it('should accept an agreement as debtor and notify the creditor', async () => {
    ...
    expect(mockNotifyPartiesUsecase.execute).toHaveBeenCalledWith({
      title: any(),
      content:
        'The debtor 5bbeec93-1049-4209-88ef-195f5acb28bc has accepted his part of the agreement.',
      partyId: '0e9f8d3b-4c66-49b0-b739-d443b15e1f4e',
    });
  });
  ...
  it('should return an error if the acceptance of the agreement by the creditor fails', async () => {
    const fakeAgreement = Agreement.reconstitute('a6f75ab2-989f-4e51-87ac-d3c5da03ce48', {
      debtorPartyId: '5bbeec93-1049-4209-88ef-195f5acb28bc',
      creditorPartyId: '0e9f8d3b-4c66-49b0-b739-d443b15e1f4e',
      createdAt: new Date(),
  ...
  it('should return an error if the acceptance of the agreement by the debtor fails', async () => {
    const fakeAgreement = Agreement.reconstitute('a6f75ab2-989f-4e51-87ac-d3c5da03ce48', {
      debtorPartyId: '5bbeec93-1049-4209-88ef-195f5acb28bc',
      creditorPartyId: '0e9f8d3b-4c66-49b0-b739-d443b15e1f4e',
      createdAt: new Date(),
